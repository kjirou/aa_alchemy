...
//{{{
  ...
  cls.__RAW_DATA = [
    ...
    ['common', 'omaemona', ['syun', 'turna'], 'ｵﾏｴﾓﾅ-', '(　´∀｀)'],
    ['common', 'itteyoshi', ['shiromaru', 'anguri'], 'ｲｯﾃﾖｼ', '( ﾟДﾟ)'],
    ['common', 'uma-', ['shiromaru', 'anguri'], 'ｳﾏ-', '(ﾟдﾟ)'],
    ...
    ['common', 'ahya2', ['shiromaru', 'a'], 'ｱﾋｬ', '(｡Ａ ｡　)'],
    ['common', 'mata-ri', ['syun', 'niya', 'no'], 'ﾏﾀｰﾘ', 'ヽ(´ー｀)ノ'],
    ['common', 'uwaaan', ['kiri', 'anguri', 'no'], 'ｳﾜｧｧｧﾝ', 'ヽ(`Д´)ﾉ'],
    ['common', 'haahaa', ['syun', 'anguri', '*'], 'ﾊｧﾊｧ', '(*´Д`)'],
    ['common', 'eeeee', ['syun', 'anguri'], '工エエェェ', '(´д｀)'],
    ['common', 'iyou', ['shiromaru', 'huguri', 'no'], 'ぃょぅ', '(=ﾟωﾟ)ﾉ'],
    ['common', 'gakugakuburuburu', ['anguri', '(((', ';'], 'ｶﾞｸｶﾞｸﾌﾞﾙﾌﾞﾙ', '((( ；ﾟДﾟ)))'],
    ...
    ['rare', 'dokuwo', ['syun', 'a', 'no'], 'ﾄﾞｸｦ',
      ' (\'A`)\nﾉ( ﾍﾍ '],
    ['rare', 'kocchiminna', ['shiromaru', 'anguri', 'tsu'], 'こっちみんな',
      '　　( ﾟдﾟ ) \n＿(__つ/￣\n　　＼/　　'],
    ['rare', 'joruju', ['shiromaru', 'turna', 'tsu'], 'ｼﾞｮﾙｼﾞｭ長岡',
      '　 _ 　∩\n(　ﾟ∀ﾟ)彡\n　⊂彡'],
